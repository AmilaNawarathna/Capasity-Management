...
Route::group(['middleware' => 'auth:api'], function()
{
    ...
    Route::group(['prefix' => '/projects/'], function () {
                ...
                Route::get('/getprojects', 'api\ProjectController@getprojects');//*****employee assign projects */*** */
    ...
    Route::get('projectEmployee','api\MethodController@projectEmployee');
    Route::post('removeEmployee','api\MethodController@removeEmployee');
    ...
    Route::post('assignEmp', 'api\AssignController@assignEmp');//********assign** */
